        ...
        >
          <template slot-scope="{ node, data }">
            <span>
              {{ node.label }}
              <el-tag
                v-show="currentNodeData.id === data.id"
                style="margin-left: 100px"
                class="custom-button"
                type="primary"
                size="mini"
                @click.stop="handleAddNode(node,data)"
              >添加节点</el-tag>
              <el-tag
                v-show="currentNodeData.id === data.id"
                ...
                type="info"
                size="mini"
                @click.stop="handleUpdateNode(node,data)"
              >更新节点</el-tag>
              <el-popconfirm
              ...
              >
                <el-tag v-show="currentNodeData.id === data.id" slot="reference" style="margin-left: 5px" type="info" size="mini" @click.stop="">删除</el-tag>
              </el-popconfirm>
              <!--                <el-popconfirm-->
              <!--                  ref="popconfirm1"-->
              <!--                  title="删除将导致所有工程/diff不可见，但记录会保留，确定么？"-->
        ...
        <el-row>
          <el-col :span="2">
            <el-button
              ...
              type="primary"
              @click="handleAddProjectForm"
            >添加项目
            </el-button>
          </el-col>
          <el-col :span="22" align="right">
            <el-button
              style="background-color: rgb(252, 190, 60); color: white; margin-bottom: 10px"
          ...
          <el-col :span="24">
            ...
            >
              ...
              <el-table-column label="操作" align="center" min-width="300" class-name="small-padding fixed-width">
                <template slot-scope="{row, $index}">
                  ...
                  >
                    <el-button slot="reference" size="mini" type="danger" style="margin-left: 20px; margin-right: 20px">
                      删除
                    </el-button>
                  </el-popconfirm>
                </template>
            ...
            <pagination
              v-show="projectListTotal > 10"
              :total="projectListTotal"
              :page.sync="listQuery.page_num"
              :limit.sync="listQuery.page_size"
              @pagination="getProjectListOnNavi(false)"
            />
          </el-col>
            ...
            <el-form label-width="200px" style="border:1px solid #C4E1C5 ; padding: 20px" oncancel="resetForm">
              <el-row>
                <el-col>
                  <el-form-item label="Git地址(ssh地址)：">
                    <el-input
                      v-model="createProjectFormData.ssh_url"
                      placeholder="例: git@gitlab.staff.xdf.cn:airesearch-ocr/general-ocr.git"
                    />
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col>
                  <el-form-item label="Git地址(http地址)：">
                    <el-input
                      v-model="createProjectFormData.http_url"
                      placeholder="例: http://gitlab.staff.xdf.cn/airesearch-ocr/general-ocr.git"
                    />
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col>
                  <el-form-item label="中文描述：">
                    <el-input v-model="createProjectFormData.description" />
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col>
                  <el-form-item label="基准分支(默认master)：">
                    <el-input v-model="createProjectFormData.default_main" />
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col>
                  <el-form-item label="选择GptPromt：">
                    <el-input v-model="createProjectFormData.gpt_config" />
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col>
                  <el-form-item label="加入的业务组：">
                    <el-input
                      v-model="currentNodeData.label"
                      :disabled="true"
                      :placeholder="currentNodeData ? currentNodeData.label : ''"
                    />
                  </el-form-item>
                </el-col>
              </el-row>
              <div style="text-align: right">
                <el-button
                  ...
                  @click="handleAddProject(createProjectFormData)"
                >提交
                </el-button>
              </div>
            </el-form>
            ...
            <el-form label-width="200px" style="border:1px solid #C4E1C5 ; padding: 20px" oncancel="resetForm">
              <el-row>
                <el-col>
                  <el-form-item label="Git地址(ssh地址)：">
                    <el-input
                      v-model="updateProjectFormData.ssh_url"
                    />
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col>
                  <el-form-item label="Git地址(http地址)：">
                    <el-input
                      v-model="updateProjectFormData.http_url"
                    />
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col>
                  <el-form-item label="中文描述：">
                    <el-input v-model="updateProjectFormData.description" />
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col>
                  <el-form-item label="基准分支(默认master)：">
                    <el-input v-model="updateProjectFormData.default_main" />
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col>
                  <el-form-item label="选择GptPromt：">
                    <el-input v-model="updateProjectFormData.gpt_config" />
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
              ...
              <el-row>
                <el-col>
                  <el-form-item label="节点名称：">
                    <el-input
                      v-model="addNodeFormData.group_name"
                    />
                  </el-form-item>
                </el-col>
              </el-row>
            ...
            <el-form label-width="200px" style="border:1px solid #C4E1C5 ; padding: 10px">
              <el-row>
                <el-col>
                  <el-form-item label="节点名称：">
                    <el-input
                      v-model="updateNodeFormData.group_name"
                    />
                  </el-form-item>
                </el-col>
              </el-row>
